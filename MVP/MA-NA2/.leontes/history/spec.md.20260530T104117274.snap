...
## Additional context
Please optimize context step in this project. Adding claude.md and colpilot-instructions not needed for now please remove section. Also Optimize with local llm, not sure if it works, if yes, then it should be visible by showing the changes before overwriting  initial context. Also it should optimize to include all of info but be more efficient for llm to not double the info and be precise. This context step should be more easy to use. Also not sure when this dialog will be saved etc.

## Materials
- **Folder** [source code](C:\WIP\leontes-devtool)
...
Please optimize context step in this project. Adding claude.md and colpilot-instructions not needed for now please remove section. Also Optimize with local llm, not sure if it works, if yes, then it should be visible by showing the changes before overwriting  initial context. Also optimize with llm should be in spec & kickoff not in context. Also it should optimize to include all of info but be more efficient for llm to not double the info and be precise. This context step should be more easy to use. Also not sure when this dialog will be saved etc. I think in this dialog we should define the rect of the context not in spec. In Spec and kickoff we should see already our spec to last edit.
