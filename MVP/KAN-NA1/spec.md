# KAN-NA1 — Materials improvements
...
### Description
When adding a folder to materials I should be able tu put label for example "legacy app backend" etc. and later it should be added to the spec.md, same for link (there is already label but pleasse malke sure we use it in spec.md).
